    ...
    <section id="about" className="bg-surface py-10 sm:py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-6 max-w-2xl text-center sm:mb-8">
          <h2 className="text-2xl font-bold text-white sm:text-3xl md:text-4xl">About Me</h2>
          <p className="mt-2 text-xs text-text-muted sm:text-sm md:text-base">
            Full-stack developer focused on reliable, scalable web applications.
          </p>
        </div>
          ...
          <div className="space-y-5 sm:space-y-6">
            <div className="space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4 shadow-lg shadow-black/10 sm:p-5">
              ...
              <p className="text-xs leading-relaxed text-text-muted sm:text-sm">
                Full-stack developer with expertise in MERN stack and ASP.NET Core. I design RESTful
                architectures, build responsive interfaces, and integrate AI-driven workflows.
              </p>
              <p className="rounded-lg border border-secondary/20 bg-secondary/10 p-2.5 text-xs text-text-light sm:p-3">
                At MamoTechnolabs LLP, I delivered e-commerce and workforce platforms—owning solution
                architecture and secure API implementation across MERN and ASP.NET ecosystems.
              </p>
            </div>
            ...
            <div className="space-y-3 rounded-2xl border border-white/10 bg-white/5 p-4 shadow-lg shadow-black/10 sm:p-5">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <h3 className="text-base font-semibold text-white sm:text-lg">What I'm Focused On</h3>
              </div>
              ...
              <div className="grid gap-2.5 sm:grid-cols-2 sm:gap-3">
                {profile.highlights.map((item) => (
                  <div
                    key={item.caption}
                    className="rounded-lg border border-white/5 bg-background/80 p-2.5 sm:p-3"
                  >
